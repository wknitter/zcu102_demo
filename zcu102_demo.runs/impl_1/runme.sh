...
HD_PWD='/home/whitney/zcu102_demo/zcu102_demo.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_bd_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source zcu102_bd_wrapper.tcl -notrace
