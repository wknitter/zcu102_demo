...
HD_PWD='/home/whitney/zcu102_demo/zcu102_demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log zcu102_bd_wrapper.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source zcu102_bd_wrapper.tcl
